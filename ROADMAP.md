...
| 9 Hardening | COMPLETE — release/SBOM/attestation/drill + CodeQL + dependabot + self-host hardening (`no-new-privileges:true`, `160 gates`, `748 tests 740 pass 0 fail`, + new `014` calendar); k8s minimal present (full TF multi-region deferred) |
